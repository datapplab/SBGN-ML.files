...
ko.to.uniprot = read.table("C:/xiaoxi/work/input/id.mapping/kegg.ortholog.100.download.slice/uniprot.to.ko.tsv",header=F,stringsAsFactors = F,sep="\t")
...
plot(density(all.cutoff.info$cutoff),main = "Distribution of species-specific pathway completeness cutoffs")
